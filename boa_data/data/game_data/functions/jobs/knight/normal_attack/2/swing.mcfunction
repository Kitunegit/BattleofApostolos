#> game_data:jobs/knight/normal_attack/2/swing
#
# 騎士_2段目攻撃処理
#
# @internal
...
# 演出
    playsound minecraft:entity.player.attack.sweep player @s ^-0.1 ^ ^ 1 0.5
    #function plugin_api:knockback/vec2 {strength:0.4}
# 斬撃演出
    execute at @s run summon text_display ~ ~1 ~ {brightness:{sky:15,block:15},transformation:{left_rotation:[-0.707f,0f,0f,0.707f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[10f,10f,10f]},background:16711680,Tags:["system.particle","paritcle.knight","particle.knight.second","particle.Rot"]}
