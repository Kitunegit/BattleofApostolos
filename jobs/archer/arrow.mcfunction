#軌道のパーティクル
execute at @e[type=arrow] run particle dust 0.016 0.247 0.122 0.1 ~ ~ ~ 0.15 0.15 0.15 2 2
execute at @e[type=arrow] run particle dust 0.043 0.706 0.341 0.1 ~ ~ ~ 0.15 0.15 0.15 2 1
#スキャンの矢
