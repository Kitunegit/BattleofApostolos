...
#矢処理
    ...
    #着弾処理
        ...
        execute if score @s archer_skill_2_cool matches 300.. as @e[type=arrow] at @s if entity @s[nbt={life:1s}] run effect give @e[distance=..10,tag=player] glowing 20 1 true
