    ...
    execute if entity @s[nbt={OnGround:1b}] run function pvp_data:pvpfunctions/jobs/archer/passive/passive_jump {angle:-60,power:8500,particle_position:"~ ~ ~"}
    #2段目空中強化
    ...
    #空中2段目未強化
    execute if entity @s[nbt={OnGround:0b},tag=!archer_jump,scores={archer_jump_count=..0}] run function pvp_data:pvpfunctions/jobs/archer/passive/passive_jump {angle:-40,power:6000,particle_position:"^ ^ ^-1"}
