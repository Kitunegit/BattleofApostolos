...
#武器変更
    item replace entity @s hotbar.0 with crossbow{display:{Name:'{"text":"弓兵の奥義クロスボウ","color":"dark_purple","bold":true}'},HideFlags:1,CustomModelData:7,ChargedProjectiles:[{},{id:"minecraft:arrow",Count:1b},{}],Charged:1b} 1
#効果付与
