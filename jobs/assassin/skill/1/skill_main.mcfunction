#スキル1処理
    ...
    #スキルエフェクト
        execute at @s if score @s skill_1_cool matches 200.. run execute at @s run particle dust 0.78 0 1 1.2 ~ ~ ~ 0.5 0.8 0.5 1 15
        execute at @s if score @s skill_1_cool matches 200.. run execute at @s run particle dust 0.31 0.01 0.33 1.2 ~ ~ ~ 0.5 0.8 0.5 1 15
    #効果終了演出
