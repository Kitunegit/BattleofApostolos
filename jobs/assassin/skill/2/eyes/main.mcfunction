#無条件処理
    ...
    execute if score @s assassin_skill_2_tmr matches 25.. run particle dust 0.435 0 1 2.5 ~ ~ ~ 0.8 0.8 0.8 1 50
    kill @e[type=marker,tag=black_eyes,scores={assassin_skill_2_tmr=25..}]
 #ブロックに当たったとき
