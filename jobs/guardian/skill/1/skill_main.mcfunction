#スキル1処理
    #発動処理
        execute as @s[nbt={SelectedItem:{tag:{CustomModelData:81},id:"minecraft:carrot_on_a_stick"}},scores={skill_1_cool=..0,r_click=1..}] run function pvp_data:pvpfunctions/jobs/guardian/skill/1/skill_start
    #バリア減らし
