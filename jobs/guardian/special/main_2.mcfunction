...
execute at @s if score @s guardian_special_cool matches 280.. rotated ~ 0 positioned ^ ^ ^6 run particle dust -1 0 0 0.75 ~ ~ ~ 0.25 0.25 0.25 0.25 5
execute at @s if score @s guardian_special_cool matches 280.. rotated ~ 0 positioned ^ ^ ^7 run particle dust -1 0 0 0.75 ~ ~ ~ 0.25 0.25 0.25 0.25 5
execute at @s if score @s guardian_special_cool matches 280.. rotated ~ 0 positioned ^ ^ ^8 run particle dust -1 0 0 0.75 ~ ~ ~ 0.25 0.25 0.25 0.25 5
execute at @s if score @s guardian_special_cool matches 280.. rotated ~ 0 positioned ^ ^ ^9 run particle dust -1 0 0 0.75 ~ ~ ~ 0.25 0.25 0.25 0.25 5
execute at @s if score @s guardian_special_cool matches 280.. rotated ~ 0 positioned ^ ^ ^10 run particle dust -1 0 0 0.75 ~ ~ ~ 0.25 0.25 0.25 0.25 5
...
execute at @s if score @s guardian_special_cool matches 276..280 rotated ~ 0 if block ^ ^ ^2.5 air run tp @s ^ ^ ^2.5
execute at @s if score @s guardian_special_cool matches 276..280 run particle sweep_attack ~ ~0.15 ~
execute at @s if score @s guardian_special_cool matches 276..280 run damage @e[distance=0.1..2,limit=1,tag=player] 5 player_attack by @s
execute at @s if score @s guardian_special_cool matches 276..280 at @e[distance=0.1..2,limit=1,tag=player] run summon area_effect_cloud ~ ~ ~ {Duration:6,Age:4,Effects:[{Id:25,Amplifier:5,Duration:2}]}
execute at @s if score @s guardian_special_cool matches 276..280 as @e[distance=0.1..2,tag=player] run effect give @s slowness 3 4 true
