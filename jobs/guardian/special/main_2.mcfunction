...
execute at @s if score @s guardian_special_cool matches 276..280 at @e[distance=0.1..2,limit=1] run summon area_effect_cloud ~ ~ ~ {Duration:6,Age:4,Effects:[{Id:25,Amplifier:5,Duration:2}]}
