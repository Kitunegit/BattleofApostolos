...
#剣の攻撃力増加
    execute as @a[nbt={SelectedItem:{tag:{CustomModelData:3},id:"minecraft:carrot_on_a_stick"},Inventory:[{Slot.hotbar.0}]}] run attribute @s generic.attack_damage base set 7
    execute as @a[scores={jobscore=3},nbt=!{SelectedItem:{tag:{CustomModelData:3},id:"minecraft:carrot_on_a_stick"}}] run attribute @s generic.attack_damage base set 1
