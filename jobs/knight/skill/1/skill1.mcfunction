...
#発動演出
    execute if score @s skill_1_cool matches 500.. run function pvp_data:pvpfunctions/jobs/knight/skill/1/skill1_effect
#終了処理
    execute if score @s skill_1_cool matches 1 run function pvp_data:pvpfunctions/jobs/knight/skill/1/skill1_fin
