...
#発動中演出
    ...
    execute at @s[scores={knight_skill_1_cool=501..}] run particle dust 100000000 100000000 100000000 1 ~ ~0.2 ~ 0.45 1 0.45 0 8 normal
...
#発動終了演出
     ...
     execute at @s[scores={knight_skill_1_cool=500}] run particle dust 10000000 10000000 10000000 1 ~ ~0.2 ~ 0.7 1.5 0.7 0 50 normal
