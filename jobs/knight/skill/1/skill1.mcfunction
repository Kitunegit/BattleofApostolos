...
#発動中演出
	...
	execute as @s[scores={knight_skikk_1_cool=301..}] at @s run effect give @s minecraft:slowness 1 0 true

#発動終了演出
     execute at @s[scores={knight_skill_1_cool=300}] run playsound block.fire.extinguish player @s ~ ~ ~ 0.5
     execute at @s[scores={knight_skikk_1_cool=300}] run particle dust 100000000 100000000 100000000 1 ~ ~0.2 ~ 0.7 2 0.7 0 10 normal
