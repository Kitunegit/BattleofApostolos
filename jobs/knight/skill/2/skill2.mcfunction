...
#発動中演出(前半)
    execute if score @s skill_2_cool matches 400.. run function pvp_data:pvpfunctions/jobs/knight/skill/2/skill2_buff

#発動演出(後半)
    execute if score @s skill_2_cool matches 600.. run function pvp_data:pvpfunctions/jobs/knight/skill/2/skill2_debuff
