...
#発動演出(後半)
    execute at @s[scores={jobscore=3,skill_2_cool=401..600}] run effect give @s resistance 0 1 true
    execute at @s[scores={jobscore=3,skill_2_cool=401..600}] run effect give @s weakness 0 1 true
