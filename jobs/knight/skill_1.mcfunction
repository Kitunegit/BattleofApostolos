...
#スキル1：片手剣の極意
    ...
    #使用後処理
        ...
        execute at @a[tag=knight_skill_1] run particle crit ~ ~1 ~ 1 1 1 10 1
        execute at @a[tag=knight_skill_1] run particle dust 0.37 0.94 0.95 0.8 ~ ~1 ~ 0.4 0.4 0.4 10 2 normal
