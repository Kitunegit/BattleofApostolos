...
#発動時処理
        execute if entity @e[tag=knight_special_switch] as @s[scores={jobscore=3,special_count=1}] if entity @e[tag=knight_special_target] run function pvp_data:pvpfunctions/jobs/knight/special/switch
