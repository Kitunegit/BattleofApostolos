    ...
    execute as @s[nbt={SelectedItem:{tag:{CustomModelData:3},id:"minecraft:carrot_on_a_stick"}},scores={knight_special_cool=1..,r_click=1..}] at @s run playsound block.bamboo_wood_button.click_on player @s
