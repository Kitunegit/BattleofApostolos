    ...
    execute as @s[scores={knight_special_count=1}] at @s positioned ^ ^ ^4 as @e[distance=..3.9,limit=3] run tag @s add knight_special_target
...
#待機処理
    ...
    execute as @s[scores={knight_special_cool=1}] run playsound block.anvil.land player @s ~ ~ ~ 0.5 2
