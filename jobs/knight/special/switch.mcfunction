...
#技処理2
    ...
    execute if score @s special_count matches 11 as @e[tag=knight_special_target,tag=player] at @s run damage @s 5 player_attack by @a[scores={special_count=1..},limit=1]
...
#技処理3
    ...
    execute if score @s special_count matches 22 as @e[tag=knight_special_target,tag=player] at @s run damage @s 5 player_attack by @a[scores={special_count=1..},limit=1]
