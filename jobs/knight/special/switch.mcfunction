...
#技処理1
    ...
    execute as @s[scores={knight_special_count=1}] at @s positioned ^ ^ ^4 as @e[distance=..3.9,limit=3] run damage @s 4 player_attack by @s
...
#技処理2
    ...
    execute as @s[scores={knight_special_count=10}] at @s positioned ^ ^ ^4 as @e[distance=..3.9,limit=3] run damage @s 4 player_attack by @s
...
#技処理3
    ...
    execute as @s[scores={knight_special_count=20}] at @s positioned ^ ^ ^4 as @e[distance=..3.9,limit=3] run damage @s 4 player_attack by @s
