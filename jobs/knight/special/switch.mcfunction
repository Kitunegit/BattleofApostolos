...
#技処理1
    ...
    execute if score @s knight_special_count matches 1 as @e[tag=knight_special_target] at @s run damage @s 5 player_attack by @a[scores={knight_special_count=1..},limit=1]
...
#技処理2
    ...
    execute if score @s knight_special_count matches 11 as @e[tag=knight_special_target] at @s run damage @s 5 player_attack by @a[scores={knight_special_count=1..},limit=1]
...
#技処理3
    ...
    execute if score @s knight_special_count matches 22 as @e[tag=knight_special_target] at @s run damage @s 5 player_attack by @a[scores={knight_special_count=1..},limit=1]
