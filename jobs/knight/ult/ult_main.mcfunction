...
#演出
    execute as @e[type=marker,tag=knight_ult,scores={knight_ult_count=3..}] at @s positioned ^ ^ ^ run particle sweep_attack ~ ~ ~ 0.5 0.5 0.5 3 5 normal
    ...
    execute as @e[type=marker,tag=knight_ult,scores={knight_ult_count=3..}] at @s positioned ^2 ^ ^-0.5 run particle sweep_attack ~ ~ ~ 0.5 0.5 0.5 3 5 normal
    ...
    execute as @e[type=marker,tag=knight_ult,scores={knight_ult_count=3..}] at @s positioned ^4 ^ ^-1 run particle sweep_attack ~ ~ ~ 0.5 0.5 0.5 3 5 normal
