...
execute as @e[type=marker,tag=knight_ult] at @s run tp @s ^ ^ ^0.3
#演出
    ...
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^1 ^ ^-0.5 run damage @a[tag=player,limit=1,distance=..3] 15 player_attack
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^-1 ^ ^-0.5 run particle sweep_attack ~ ~ ~ 0.5 0.5 0.5 1 1 normal
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^-1 ^ ^-0.5 run damage @a[tag=player,limit=1,distance=..3] 15 player_attack
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^2 ^ ^-1 run particle sweep_attack ~ ~ ~ 0.5 0.5 0.5 1 1 normal
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^2 ^ ^-1 run damage @a[tag=player,limit=1,distance=..3] 15 player_attack
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^-2 ^ ^-1 run particle sweep_attack ~ ~ ~ 0.5 0.5 0.5 1 1 normal
    execute as @e[type=marker,tag=knight_ult] at @s positioned ^-2 ^ ^-1 run damage @a[tag=player,limit=1,distance=..3] 15 player_attack
