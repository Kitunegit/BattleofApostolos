...
scoreboard players operation @a[scores={protector_skill_1_cool=1..}] protector_skill_1_cool %= item_cool_check protector_skill_1_cool

execute if score item_cool_check protector_skill_1_cool matches 0 run clear @a[scores={protector_skill_1_cool=1..}] barrier{CustomModelData:81} 1