...
execute at @a[scores={protector_r_detect=1..,protector_skill_2_cool=1..},nbt={SelectedItem:{tag:{CustomModelData:81},id:"minecraft:carrot_on_a_stick"}}] run playsound ui.button.click player @a[scores={protector_r_detect=1..,protector_skill_2_cool=1..},nbt={SelectedItem:{tag:{CustomModelData:81},id:"minecraft:carrot_on_a_stick"}}]
scoreboard players set @a[scores={protector_r_detect=1..,protector_skill_2_cool=1..}] protector_r_detect 0
