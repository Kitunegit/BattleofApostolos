    ...
    execute at @s positioned ~-0.5 ~ ~-0.5 if entity @e[dx=0] if score @s wizard_normal_count matches 2.. run damage @e[tag=player,dx=0,sort=nearest,limit=1] 6 magic by @a[scores={jobscore=2},limit=1]
