...
execute if score @s aj.warrior_ult.model.animation.ult_fall.local_anim_time matches 11.. run function animated_java:warrior_ult.model/zzzzzzzz/animations/ult_fall/end