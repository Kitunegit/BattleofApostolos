#軌道のパーティクル
execute at @e[type=arrow] run particle dust 0.016 0.247 0.122 2 ~ ~ ~ 0.15 0.15 0.15 2 1
execute at @e[type=arrow] run particle dust 0.043 0.706 0.341 2 ~ ~ ~ 0.15 0.15 0.15 2 1
#スキャンの矢
