...
#その他処理
    item replace entity @s hotbar.2 with barrier{display:{Name:'{"text":"クールタイム中です","color":"blue","bold":true,"italic":false}',Lore:['{"text":"漆黒の靄を飛ばす。","color":"white","italic":false}','{"text":"この靄に触れたら視界を奪われる。","color":"white","italic":false}','{"text":"─────発動効果─────","color":"gray","italic":false}','[{"text":"漆黒の靄を飛ばす。","color":"white","bold":true,"italic":false}]','[{"text":"\\uE018","color":"white","italic":false},{"text":"盲目","color":"white","bold":true,"italic":false},{"text":"(0:05)","color":"dark_red","bold":true,"italic":false}]','[{"text":"\\uE017","color":"white","italic":false},{"text":"クールタイム","color":"white","bold":true},{"text":"1:00","color":"dark_green","bold":false}]']},CustomModelData:62} 16
