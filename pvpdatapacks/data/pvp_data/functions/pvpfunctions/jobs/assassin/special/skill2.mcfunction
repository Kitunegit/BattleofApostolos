...
function pvp_data:pvpfunctions/systems/job_system/damage/apply {damage: {amount: 16.0f,type: "pvp_data:assassin/assassin_sp"},knockback: {horizontal: 0.5d,vertical: 0.5d},target: "@e[tag=assassin_sp_trgt,limit=1]"}
