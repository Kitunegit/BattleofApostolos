...
# 処理
    execute at @s positioned ^ ^ ^4 run say 実行
    ...
    function pvp_data:pvpfunctions/systems/job_system/damage/apply_fixed {damage: {amount: 4.0f,type: "pvp_data:assassin/assassin_sp"},knockback: {horizontal: 0.5d,vertical: 0.5d},target: "@e[tag=assassin.sp_target]"}
