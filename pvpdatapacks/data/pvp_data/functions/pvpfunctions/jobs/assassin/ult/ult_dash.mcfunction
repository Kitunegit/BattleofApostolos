...
# Hit判定
    ...
    execute at @s run function pvp_data:pvpfunctions/systems/job_system/damage/apply {amount: 35000f, type: "pvp_data:assassin/assassin_ult", knockback_strength: 4d, target: "@e[tag=player,distance=0.1..2]"}
# 時間
