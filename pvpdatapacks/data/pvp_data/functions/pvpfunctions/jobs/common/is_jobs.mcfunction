execute if score @s jobscore matches 1 run function pvp_data:pvpfunctions/jobs/common/job/builider
execute if score @s jobscore matches 2 run function pvp_data:pvpfunctions/jobs/common/job/wizard
execute if score @s jobscore matches 3 run function pvp_data:pvpfunctions/jobs/common/job/knight
execute if score @s jobscore matches 4 run function pvp_data:pvpfunctions/jobs/common/job/warrior
