...
execute at @s if score @s special_cool matches 276..280 run function pvp_data:pvpfunctions/systems/job_system/damage/apply {amount: 5f, type: player_attack, knockback_strength: 1d, target: "@e[distance=0.1..2,limit=1,tag=player]"}
