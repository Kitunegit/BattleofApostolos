...
#技処理
    ...
    execute as @a[scores={special_count=1..},limit=1] run function pvp_data:pvpfunctions/systems/job_system/damage/apply_fixed {damage: {amount: 2.0f,type: "pvp_data:knight/knight_sp"},knockback: {horizontal: 0d,vertical: 0d},target: "@e[tag=knight_special_target,tag=player]"}
