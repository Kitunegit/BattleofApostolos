...
# ダメージ
    function pvp_data:pvpfunctions/systems/job_system/damage/apply_fixed {damage: {amount: 3.0f,type: "pvp_data:knight/knight_sp"},knockback: {horizontal: 0.01d,vertical: 0.0d},target: "@e[tag=Knight.Special_damage]"}
