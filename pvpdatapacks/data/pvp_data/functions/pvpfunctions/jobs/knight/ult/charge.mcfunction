...
#ため演出
    ...
    execute at @s if score @s knight_ult_count matches 1.. unless block ~ ~-1 ~ air run effect give @s levitation 1 128 true
    ...
    execute if score @s knight_ult_count matches 65.. run effect clear @s levitation