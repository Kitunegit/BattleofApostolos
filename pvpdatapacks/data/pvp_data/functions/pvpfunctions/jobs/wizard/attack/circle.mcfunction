...
execute if score @s wizard_normal_count matches 1 run data modify entity @s transformation.scale set value [1.5,1.5,1.5]
execute if score @s wizard_normal_count matches 1 run data modify entity @s interpolation_duration set value 5
execute if score @s wizard_normal_count matches 1 run data modify entity @s start_interpolation set value -1
