    ...
    execute at @s positioned ~-0.5 ~ ~-0.5 if entity @e[dx=0] if score @s wizard_normal_count matches 2.. run function pvp_data:pvpfunctions/systems/job_system/damage/apply {amount: 2f, type: magic, knockback_strength: 0d, target: "@e[tag=player,dx=0]"}
