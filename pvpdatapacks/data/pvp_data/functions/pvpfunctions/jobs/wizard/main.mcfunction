...
execute if entity @s[tag=wizard_white] run function pvp_data:pvpfunctions/jobs/wizard/ult/white/main
execute if entity @s[tag=wizard_black] run function pvp_data:pvpfunctions/jobs/wizard/skill/3/main
execute if entity @s[tag=wizard_black] run function pvp_data:pvpfunctions/jobs/wizard/ult/black/main
...
function pvp_data:pvpfunctions/jobs/wizard/ult/main