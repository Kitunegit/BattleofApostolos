...
execute if score @s sneaking matches 1 at @s run scoreboard players remove @s passive_count 30
execute if score @s sneaking matches 5 at @s run playsound minecraft:entity.ender_eye.death player @s ~ ~ ~ 0.5 0.8
execute if score @s sneaking matches 5 at @s run scoreboard players remove @s passive_count 30
execute if score @s sneaking matches 10 at @s run playsound minecraft:entity.ender_eye.death player @s ~ ~ ~ 0.5 1.0
execute if score @s sneaking matches 10 at @s run scoreboard players remove @s passive_count 30
execute if score @s sneaking matches 15 at @s run playsound minecraft:entity.ender_eye.death player @s ~ ~ ~ 0.5 1.2
execute if score @s sneaking matches 15 at @s run scoreboard players remove @s passive_count 30
# Sneaking20
    execute if score @s sneaking matches 20 at @s run scoreboard players remove @s passive_count 30
