#スキル1発動処理
    #発動処理
        execute if predicate pvp_data:r_click/cmd25 if score @s skill_2_cool matches ..0 if score @s r_click matches 1.. run function pvp_data:pvpfunctions/jobs/wizard/skill/3/skill_start
