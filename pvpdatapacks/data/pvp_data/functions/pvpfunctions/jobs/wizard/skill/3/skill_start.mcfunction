...
execute at @s run summon item_display ~ ~10 ~ {interpolation_duration:0,Tags:["wizard_skill2_black"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[7.5f,7.5f,2f]},item:{id:"minecraft:quartz",Count:1b,tag:{CustomModelData:2}}}
