...
# 使用中常時実行
    ...
    execute if data entity @s SelectedItem.tag.consume if score $remainder system.consume_item.using_time matches 0 run function pvp_data:pvpfunctions/systems/consume_item/sound with entity @s SelectedItem.tag.consume.sound
