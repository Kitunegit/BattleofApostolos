#> pvp_data:pvpfunctions/systems/player_attack/max_charged_arrow

# 射撃時
    # advancement剥奪
        advancement revoke @s only pvp_data:system/player_attack/max_charged_arrow
    ...
    # ダメージ処理
        ...
        # ダメージ
            ...
            function pvp_data:pvpfunctions/systems/job_system/damage/apply {target: "@e[tag=system.player_attack.attacked_candidate]", damage: {amount: 14.0f, type: "pvp_data:system/override"}, knockback: {horizontal: 0.25d, vertical: 0.4d}}
