...
# 射撃時
    ...
    # ダメージ処理
        ...
        # ダメージ
            ...
            function pvp_data:pvpfunctions/systems/job_system/damage/apply {target: "@e[tag=system.player_attack.attacked_candidate]", damage: {amount: 2.0f, type: "pvp_data:system/override"}, knockback: {horizontal: 0.25d, vertical: 0.4d}}
