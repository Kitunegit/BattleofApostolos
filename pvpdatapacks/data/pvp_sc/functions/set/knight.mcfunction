...
item replace entity @s hotbar.0 with carrot_on_a_stick{display:{Name:'{"text":"騎士の聖剣","color":"dark_green","bold":true,"italic":false}',Lore:['{"text":"騎士の持つこの聖剣が、","color":"white","italic":false}','{"text":"悪しきものを断ち切るだろう。","color":"white","italic":false}','{"text":"─────武器効果─────","color":"gray","italic":false}','[{"text":"\\uE010","color":"white","italic":false},{"text":"物理ダメージ","color":"white","bold":true,"italic":false},{"text":"+3","color":"green","bold":false,"italic":false}]','[{"text":"\\uE015","color":"white","italic":false},{"text":"クリティカル","color":"white","bold":true,"italic":false},{"text":"+5","color":"green","bold":false,"italic":false}]']},Unbreakable:1b,CustomModelData:3,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:1,Operation:0,UUID:[I;43329248,1324630099,-1103342015,-654212017],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-0.25,Operation:0,UUID:[I;756522232,-1910814835,-1890803011,-1932999027],Slot:"mainhand"}],HideFlags:6,data: ["no_drop"]} 1
