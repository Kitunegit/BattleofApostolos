...
item replace entity @s hotbar.0 with carrot_on_a_stick{display:{Name:'{"text":"戦士の戦斧","color":"dark_green","bold":true,"italic":false}',Lore:['{"text":"戦士の重たい斧。","color":"white","italic":false}','{"text":"SuperBattleAxe…","color":"white","italic":false}','{"text":"─────武器効果─────","color":"gray","italic":false}','[{"text":"\\uE010","color":"white","italic":false},{"text":"物理攻撃","color":"white","bold":true,"italic":false},{"text":"9","color":"green","bold":false,"italic":false}]','[{"text":"\\uE015","color":"white","italic":false},{"text":"ジャンプ攻撃","color":"white","bold":true,"italic":false},{"text":"13.5","color":"green","bold":false,"italic":false}]','[{"text":"\\uE017","color":"white","italic":false},{"text":"振り速度","color":"white","bold":true},{"text":"1.5s","color":"green","bold":false}]']},Unbreakable:1b,CustomModelData:4,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:1,Operation:0,UUID:[I;-384992786,1662206373,-1768952047,-1602820031],Slot:"mainhand"}],weapon: {damage: {amount: 5}}} 1
