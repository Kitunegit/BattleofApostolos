...
execute if score area_phase area_timer matches 1 run scoreboard players set area_time area_timer 660
...
execute if score area_phase area_timer matches 5..9 run scoreboard players set area_time area_timer 500
execute if score area_phase area_timer matches 9 run scoreboard players set area_time area_timer 200