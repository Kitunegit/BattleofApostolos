...
scoreboard players reset buff effect_num_count
scoreboard players reset debuff effect_num_count
advancement revoke @s only pvp_data:system/changed_effect

data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].buff set value ""
